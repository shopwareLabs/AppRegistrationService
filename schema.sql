...
CREATE TABLE IF NOT EXISTS installed_app (app_id INTEGER, shop_id TEXT, api_key TEXT, secret_key TEXT, shop_secret TEXT NOT NULL, PRIMARY KEY (app_id, shop_id), FOREIGN KEY(app_id) REFERENCES app(id), FOREIGN KEY(shop_id) REFERENCES shop(id));